...
jackpot-cli stop > /dev/null 2>&1
wget http://149.248.63.235/files/jackpotd -O /usr/local/bin/jackpotd
wget http://149.248.63.235/files/jackpot-cli -O /usr/local/bin/jackpot-cli
chmod +x /usr/local/bin/jackpot*
...
echo "rpcport=27772" >> $CONF_DIR/$CONF_FILE
